...
public class StoreFileWriter implements Compactor.CellSink {
   ...
   */
  StoreFileWriter(FileSystem fs, Path path,
  ...
  public static class Builder {
    ...
    public StoreFile.Writer build() throws IOException {
      ...
      return new StoreFile.Writer(fs, filePath, conf, cacheConf, comparator, bloomType, maxKeyCount,
          favoredNodes, fileContext, shouldDropCacheBehind, trt);
    }
  }
}