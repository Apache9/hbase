...
public abstract class UserScanQueryMatcher extends ScanQueryMatcher {
  ...
  private static KeyValue createStartKey(Scan scan, ScanInfo scanInfo) {
    if (scan.includeStartRow()) {
      return createStartKeyFromRow(scan.getStartRow(), scanInfo);
    } else {
      return KeyValue.createLastOnRow(scan.getStartRow());
    }
  }
  ...
  public boolean moreRowsMayExistAfter(Cell cell) {
    ...
    return moreRowsMayExistsAfter(rowComparator.compareRows(cell.getRowArray(), cell.getRowOffset(),
