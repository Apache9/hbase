...
public class AsyncRegionReplicationRetryingCaller extends AsyncRpcRetryingCaller<Void> {
  ...
  private final Pair<ReplicateWALEntryRequest, CellScanner> pair;
  ...
  public AsyncRegionReplicationRetryingCaller(HashedWheelTimer retryTimer,
    ...
    this.pair = ReplicationProtobufUtil.buildReplicateWALEntryRequest(entries.toArray(new Entry[0]),
      replica.getEncodedNameAsBytes(), null, null, null);
  }
