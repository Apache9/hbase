...
public class HRegionServer extends HasThread implements
  ...
  RegionLoad createRegionLoad(final HRegion r, RegionLoad.Builder regionLoadBldr,
    ...
    regionLoadBldr.setRegionSpecifier(regionSpecifier.build())
      ...
      .setReadRequestsPerSecond(r.getReadRequestsCountPerSecond())
      .setWriteRequestsPerSecond(r.getWriteRequestsCountPerSecond())
      .setGetRequestsPerSecond(r.getGetRequestsCountPerSecond())
      .setScanRequestsPerSecond(r.getScanRequestsCountPerSecond())
      .setScanRowsPerSecond(r.getScanRowsCountPerSecond())
      ...
      .setReadCellCountPerSecond(r.getReadCellsPerSecond())
      .setReadRawCellCountPerSecond(r.getReadRawCellsPerSecond())
