...
public abstract class HBaseServerBase extends Thread implements Server, ConfigurationObserver {
  ...
  protected final synchronized void setupClusterConnection() throws IOException {
    if (asyncClusterConnection == null) {
      ...
      InetSocketAddress localAddress =
        new InetSocketAddress(getHBaseRpcServices().getSocketAddress().getAddress(), 0);
  ...
  public HBaseServerBase(Configuration conf, String name)
    ...
    InetSocketAddress addr = getHBaseRpcServices().getSocketAddress();
  ...
  public AccessChecker getAccessChecker() {
    return getHBaseRpcServices().getAccessChecker();
  }

  public ZKPermissionWatcher getZKPermissionWatcher() {
    return getHBaseRpcServices().getZkPermissionWatcher();
  }
  ...
  public RpcServerInterface getRpcServer() {
    return getHBaseRpcServices().getRpcServer();
  }
  ...
  protected abstract void setUpRpcServices() throws IOException;

  protected abstract HBaseRpcServicesBase<?> getHBaseRpcServices();
