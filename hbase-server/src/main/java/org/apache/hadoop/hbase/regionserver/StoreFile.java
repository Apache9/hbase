...
public class StoreFile {
  ...
  /**
   * @deprecated Since 1.4, removed in 2.0. This dummy is here only to maintain backward
  ...
  public static class Writer extends StoreFileWriter {
    ...
    Writer(FileSystem fs, Path path, Configuration conf, CacheConfig cacheConf,
