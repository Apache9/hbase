...
public final class CreateStoreFileWriterParams {
  ...
  public CreateStoreFileWriterParams setMaxKeyCount(long maxKeyCount) {
   ...
   */
  public CreateStoreFileWriterParams setCompression(Compression.Algorithm compression) {
   ...
   */
  public CreateStoreFileWriterParams setCompaction(boolean isCompaction) {
    this.isCompaction = isCompaction;
    return this;
  }

  public boolean isIncludeMVCCReadpoint() {
   ...
   */
  public CreateStoreFileWriterParams setIncludeMVCCReadpoint(boolean includeMVCCReadpoint) {
    this.includeMVCCReadpoint = includeMVCCReadpoint;
    return this;
  }

  public boolean isIncludesTag() {
    return includesTag;
  }
   ...
   */
  public CreateStoreFileWriterParams setIncludesTag(boolean includesTag) {
    this.includesTag = includesTag;
    return this;
  }

  public boolean isShouldDropBehind() {
    return shouldDropBehind;
  }

  public CreateStoreFileWriterParams setShouldDropBehind(boolean shouldDropBehind) {
  ...
  public CreateStoreFileWriterParams setTotalCompactedFilesSize(long totalCompactedFilesSize) {
    this.totalCompactedFilesSize = totalCompactedFilesSize;
    return this;
  }

  public String getFileStoragePolicy() {
    return fileStoragePolicy;
  }

  public CreateStoreFileWriterParams setFileStoragePolicy(String fileStoragePolicy) {
