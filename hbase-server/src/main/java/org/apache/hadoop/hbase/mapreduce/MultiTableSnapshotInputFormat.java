 ...
 * {@link org.apache.hadoop.hbase.mapreduce.TableSnapshotInputFormat} allowing a MapReduce job to
 * run over one or more table snapshots, with one or more scans configured for each. Internally, the
