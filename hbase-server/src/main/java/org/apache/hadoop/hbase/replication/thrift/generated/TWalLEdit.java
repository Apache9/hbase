 ...
 * 
 */
public class TWalLEdit implements org.apache.thrift.TBase<TWalLEdit, TWalLEdit._Fields>, java.io.Serializable, Cloneable {
  ...
  public TWalLEdit(TWalLEdit other) {
    if (other.isSetMutations()) {
      List<TColumnValue> __this__mutations = new ArrayList<TColumnValue>();
  ...
  public int compareTo(TWalLEdit other) {
    ...
    TWalLEdit typedOther = (TWalLEdit)other;
