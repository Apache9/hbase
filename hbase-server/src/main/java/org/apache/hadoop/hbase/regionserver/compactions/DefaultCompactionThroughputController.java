...
/**
 * The default compaction throughput controller. It use the follow schema to limit throughput
 * <ul>
...
public class DefaultCompactionThroughputController extends Configured implements
    CompactionThroughputController, Stoppable {

  private final static Log LOG = LogFactory.getLog(DefaultCompactionThroughputController.class);
  ...
  @Override
  public void setupThroughputTuner(final RegionServerServices server) {
