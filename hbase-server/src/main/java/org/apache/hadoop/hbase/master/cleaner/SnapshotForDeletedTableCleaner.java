...
public class SnapshotForDeletedTableCleaner extends ScheduledChore {

  private static final Logger LOG = LoggerFactory.getLogger(SnapshotForDeletedTableCleaner.class);
  ...
  public SnapshotForDeletedTableCleaner(int period, Stoppable stopper,
    ...
    super("SnapshotForDeletedTableCleaner", stopper, period);
