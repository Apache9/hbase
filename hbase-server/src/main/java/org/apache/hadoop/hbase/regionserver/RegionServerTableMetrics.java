...
public class RegionServerTableMetrics {
  ...
  public void updateScan(TableName table, long time) {
    latencies.updateScan(table.getNameAsString(), time);
  }

  public void updateBatch(TableName table, long time) {
    latencies.updateBatch(table.getNameAsString(), time);
  }
  ...
  @VisibleForTesting
  public MetricsTableLatencies getMetricsTableLatency() {
    return latencies;
  }
}
