...
public class IdReadWriteLock {
  ...
  public IdReadWriteLock(ReferenceType referenceType) {
    ...
    switch (referenceType) {
      case SOFT:
        lockPool =
            new SoftObjectPool<>(new ObjectPool.ObjectFactory<Long, ReentrantReadWriteLock>() {
              @Override
      ...
      default:
        lockPool =
            new WeakObjectPool<>(new ObjectPool.ObjectFactory<Long, ReentrantReadWriteLock>() {
              @Override
              public ReentrantReadWriteLock createObject(Long id) {
                return new ReentrantReadWriteLock();
              }
