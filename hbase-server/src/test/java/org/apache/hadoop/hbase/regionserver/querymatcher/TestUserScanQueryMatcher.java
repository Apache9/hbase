...
public class TestUserScanQueryMatcher extends AbstractTestScanQueryMatcher {
  ...
  public void testMatchExplicitColumns() throws IOException {
    ...
    UserScanQueryMatcher qm = UserScanQueryMatcher.create(scan,
      new ScanInfo(fam2, 0, 1, ttl, KeepDeletedCells.FALSE, 0, rowComparator),
  ...
  public void testMatchWildcard() throws IOException {
    ...
    long now = EnvironmentEdgeManager.currentTimeMillis();
    UserScanQueryMatcher qm = UserScanQueryMatcher.create(scan,
      new ScanInfo(fam2, 0, 1, ttl, KeepDeletedCells.FALSE, 0, rowComparator), null, now - ttl, now,
      null);
   ...
   */
  @Test
  public void testMatchExpiredExplicit() throws IOException {
    ...
    long now = EnvironmentEdgeManager.currentTimeMillis();
    UserScanQueryMatcher qm = UserScanQueryMatcher.create(scan,
      new ScanInfo(fam2, 0, 1, testTTL, KeepDeletedCells.FALSE, 0, rowComparator),
   ...
   */
  @Test
  public void testMatchExpiredWildcard() throws IOException {
    ...
    long now = EnvironmentEdgeManager.currentTimeMillis();
    UserScanQueryMatcher qm = UserScanQueryMatcher.create(scan,
      new ScanInfo(fam2, 0, 1, testTTL, KeepDeletedCells.FALSE, 0, rowComparator), null,
