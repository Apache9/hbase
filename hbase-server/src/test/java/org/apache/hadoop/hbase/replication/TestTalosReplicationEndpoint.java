  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    for (int i = 0; i < 100; i++) {
      WAL.Entry entry = new WAL.Entry(
          new WALKeyImpl(encodedRegionName, TEST_TABLE, i, now, clusterId), new WALEdit());
      entries.add(entry);
      WAL.Entry entry1 = new WAL.Entry(
          new WALKeyImpl(encodedRegionName2, TEST_TABLE, i, now, clusterId), new WALEdit());
      entries.add(entry1);
      WAL.Entry entry2 = new WAL.Entry(
          new WALKeyImpl(encodedRegionName3, TEST_TABLE_2, i, now, clusterId), new WALEdit());
      entries.add(entry2);
    }
