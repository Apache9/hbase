...
public class TestMasterFifoRpcScheduler {
  ...
  public void testCallQueueInfo() throws Exception {
    ...
    RpcScheduler scheduler = new MockMasterFifoRpcScheduler(conf, 2);
    scheduler.start();
  ...
  private class MockMasterFifoRpcScheduler extends MasterFifoRpcScheduler {

    public MockMasterFifoRpcScheduler(Configuration conf, int handlerCount) {
