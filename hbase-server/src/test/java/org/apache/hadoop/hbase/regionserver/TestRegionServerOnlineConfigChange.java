...
public class TestRegionServerOnlineConfigChange {
  ...
  public static void setUp() throws Exception {
    ...
    r1name = hbaseTestingUtility.getHBaseCluster().getRegions(TABLE1).get(0).getRegionName();
  ...
  public void testCompactionConfigurationOnlineChange() throws IOException {
    ...
    double newCompactionRatio =
        hstore.storeEngine.getCompactionPolicy().getConf().getCompactionRatio() + 0.1;
