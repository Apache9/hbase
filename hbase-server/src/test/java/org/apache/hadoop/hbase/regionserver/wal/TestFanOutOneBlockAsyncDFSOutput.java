...
public class TestFanOutOneBlockAsyncDFSOutput {
  ...
  private static final class FlushHandler implements CompletionHandler<Long, Void> {
  ...
  private void writeAndVerify(EventLoop eventLoop, Path f, final FanOutOneBlockAsyncDFSOutput out)
    ...
    final FlushHandler handler = new FlushHandler();
  ...
  public void test() throws IOException, InterruptedException, ExecutionException {
    ...
    final FanOutOneBlockAsyncDFSOutput out =
        FanOutOneBlockAsyncDFSOutputHelper.createOutput(FS, f, true, (short) 3,
