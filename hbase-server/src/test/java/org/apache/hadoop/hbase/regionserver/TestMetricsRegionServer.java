...
public class TestMetricsRegionServer {
  ...
  public void testWrapperSource() {
    ...
    HELPER.assertCounter("readRequestsCountPerSecond", 1, serverSource);
    HELPER.assertCounter("writeRequestsCountPerSecond", 2, serverSource);
    HELPER.assertCounter("getRequestsCountPerSecond", 3, serverSource);
    HELPER.assertCounter("scanRequestsCountPerSecond", 4, serverSource);
    HELPER.assertCounter("scanRowsCountPerSecond", 5, serverSource);
    HELPER.assertCounter("readRequestsByCapacityUnitPerSecond", 6, serverSource);
    HELPER.assertCounter("writeRequestsByCapacityUnitPerSecond", 7, serverSource);
    HELPER.assertCounter("readCellsPerSecond", 8, serverSource);
    HELPER.assertCounter("readRawCellsPerSecond", 9, serverSource);
