...
public class TestMetricsRegionServer {
  ...
  public void testWrapperSource() {
    ...
    HELPER.assertCounter("readRequestsPerSecond", 1, serverSource);
    HELPER.assertCounter("writeRequestsPerSecond", 2, serverSource);
    HELPER.assertCounter("getRequestsPerSecond", 3, serverSource);
    ...
    HELPER.assertCounter("readCellCountPerSecond", 8, serverSource);
    HELPER.assertCounter("readRawCellCountPerSecond", 9, serverSource);
