...
public class TestHLog  {
  ...
  public void testFindMemStoresEligibleForFlush() throws Exception {
    ...
    try {
      ...
      hlog.startCacheFlush(hri1.getEncodedNameAsBytes(), Long.MAX_VALUE, Long.MAX_VALUE, sequenceId1);
      hlog.rollWriter();
  ...
  */
   ...
   */
  private void flushRegion(HLog hlog, byte[] regionEncodedName, AtomicLong sequenceId) {
