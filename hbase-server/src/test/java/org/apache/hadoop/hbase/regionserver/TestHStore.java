...
public class TestHStore {
  ...
  public void testCreateWriter() throws Exception {
    ...
    StoreFileWriter writer = store.getStoreEngine().getStoreFileTracker()
      .createWriter(CreateStoreFileWriterParams.create().setMaxKeyCount(4)
        .setCompression(hcd.getCompressionType()).setCompaction(false).setIncludeMVCCReadpoint(true)
        .setIncludesTag(false).setShouldDropBehind(false));
  ...
  public void testHFileContextSetWithCFAndTable() throws Exception {
    init(this.name.getMethodName());
    StoreFileWriter writer = store.getStoreEngine().getStoreFileTracker()
      .createWriter(CreateStoreFileWriterParams.create().setMaxKeyCount(10000L)
        .setCompression(Compression.Algorithm.NONE).setCompaction(true)
        .setIncludeMVCCReadpoint(true).setIncludesTag(false).setShouldDropBehind(true));
