...
public class TestAsyncClusterAdminApi extends TestAsyncAdminBase {
  ...
  public void testStop() throws Exception {
    ...
    try {
      ...
      // TODO: The reason is rpc server is closed, then the response can't send to client
      LOG.warn("Got exception when stop regionserver " + rs.getServerName(), e);
    }
    ...
    try {
      ...
      // TODO: The reason is rpc server is closed, then the response can't send to client
      LOG.warn("Got exception when stop master", e);
    }
