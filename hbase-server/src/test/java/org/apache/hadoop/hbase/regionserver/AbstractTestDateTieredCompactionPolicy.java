...
public class AbstractTestDateTieredCompactionPolicy extends TestCompactionPolicy {
  ...
  private DateTieredCompactionRequest getRequest(long now, ArrayList<StoreFile> candidates,
  ...
  protected void compactEqualsStoragePolicy(long now, ArrayList<StoreFile> candidates,
