...
public class VerifyingRSGroupAdmin implements Admin, Closeable {
  ...
  public HTableDescriptor[] listTables(Pattern pattern) throws IOException {
    return admin.listTables(pattern);
  }
  ...
  public HTableDescriptor[] listTables(Pattern pattern, boolean includeSysTables) throws IOException {
    return admin.listTables(pattern, includeSysTables);
  }
  ...
  public HTableDescriptor[] listTables(String regex, boolean includeSysTables) throws IOException {
    return admin.listTables(regex, includeSysTables);
  }
  ...
  public TableName[] listTableNames(String regex) throws IOException {
    return admin.listTableNames(regex);
  }
  ...
  public TableName[] listTableNames(String regex, boolean includeSysTables) throws IOException {
    return admin.listTableNames(regex, includeSysTables);
  }
  ...
  public HTableDescriptor[] deleteTables(Pattern pattern) throws IOException {
    return admin.deleteTables(pattern);
  }
  ...
  public HTableDescriptor[] enableTables(Pattern pattern) throws IOException {
    return admin.enableTables(pattern);
  }
  ...
  public HTableDescriptor[] disableTables(Pattern pattern) throws IOException {
    return admin.disableTables(pattern);
  }
  ...
  public Pair<Integer, Integer> getAlterStatus(TableName tableName) throws IOException {
    return getAlterStatus(tableName);
  }
  ...
  public List<HRegionInfo> getTableRegions(TableName tableName) throws IOException {
    return getTableRegions(tableName);
  }
  ...
  public HTableDescriptor[] getTableDescriptors(List<String> names) throws IOException {
    return admin.getTableDescriptors(names);
  }
  ...
  public Future<Void> restoreSnapshotAsync(String snapshotName) throws IOException {
    return admin.restoreSnapshotAsync(snapshotName);
  }
  ...
  public List<SnapshotDescription> listSnapshots(String regex) throws IOException {
    return admin.listSnapshots(regex);
  }
  ...
  public List<SnapshotDescription> listTableSnapshots(String tableNameRegex,
    ...
    return admin.listTableSnapshots(tableNameRegex, snapshotNameRegex);
  }
  ...
  public QuotaRetriever getQuotaRetriever(QuotaFilter filter) throws IOException {
    return admin.getQuotaRetriever(filter);
  }
  ...
  public ReplicationLoadSource getPeerMaxReplicationLoad(String peerId) throws IOException {
    return admin.getPeerMaxReplicationLoad(peerId);
  }
  ...
  public void dissolveRSGroupLocally(String groupName) throws IOException {
    admin.dissolveRSGroupLocally(groupName);
    verify();
  }
