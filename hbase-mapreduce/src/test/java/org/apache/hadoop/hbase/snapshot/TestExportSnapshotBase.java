...
public class TestExportSnapshotBase {

  private static final Logger LOG = LoggerFactory.getLogger(TestExportSnapshotBase.class);
  ...
  protected byte[] snapshotName;

  protected int tableNumFiles;

  protected byte[] emptySnapshotName;
  ...
  protected static void testExportFileSystemState(final Configuration conf, final TableName tableName,
      ...
      final TestExportSnapshot.RegionPredicate bypassregionPredicate, boolean success) throws Exception {
  ...
  protected static Set<String> verifySnapshot(final Configuration conf, final FileSystem fs,
      ...
      final TestExportSnapshot.RegionPredicate bypassregionPredicate) throws IOException {
    ...
    SnapshotProtos.SnapshotDescription
        desc = SnapshotDescriptionUtils.readSnapshotInfo(fs, exportedSnapshot);
  ...
  protected Path getLocalDestinationDir() {
