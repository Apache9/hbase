...
import com.xiaomi.infra.thirdparty.org.apache.thrift.transport.TFramedTransport;
import com.xiaomi.infra.thirdparty.org.apache.thrift.transport.TNonblockingServerSocket;
import com.xiaomi.infra.thirdparty.org.apache.thrift.transport.TNonblockingServerTransport;
import com.xiaomi.infra.thirdparty.org.apache.thrift.transport.TSaslServerTransport;
import com.xiaomi.infra.thirdparty.org.apache.thrift.transport.TServerSocket;
...
public class ThriftServerRunner implements Runnable {
  ...
  public static class HBaseHandler implements Hbase.Iface {
     ...
     * @throws IOError
     */
    public HTable getTable(final byte[] tableName) throws IOException {
      return (HTable) connectionCache.getTable(tableName);
    }
    ...
    protected HBaseHandler(final Configuration c, final UserProvider userProvider)
        throws IOException {
      this.conf = c;
