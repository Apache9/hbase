...
public class TRowMutations implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<TRowMutations, TRowMutations._Fields>, java.io.Serializable, Cloneable, Comparable<TRowMutations> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("TRowMutations");
  ...
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField MUTATIONS_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("mutations", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST, (short)2);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRowMutationsStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRowMutationsTupleSchemeFactory();

  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer row; // required
  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<TMutation> mutations; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.MUTATIONS, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("mutations", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.ListMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST, 
            new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.StructMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, TMutation.class))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRowMutations.class, metaDataMap);
  }
  ...
  public TRowMutations setRow(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer row) {
    this.row = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(row);
    return this;
  }
  ...
  public TRowMutations setMutations(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<TMutation> mutations) {
    this.mutations = mutations;
    return this;
  }
  ...
  private static class TRowMutationsStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TRowMutationsStandardScheme getScheme() {
      return new TRowMutationsStandardScheme();
    }
  }

  private static class TRowMutationsStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<TRowMutations> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, TRowMutations struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // MUTATIONS
            if (schemeField.type == com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST) {
              {
                com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList _list134 = iprot.readListBegin();
                struct.mutations = new java.util.ArrayList<TMutation>(_list134.size);
                @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TMutation _elem135;
    ...
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, TRowMutations struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TRowMutationsTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TRowMutationsTupleScheme getScheme() {
      return new TRowMutationsTupleScheme();
    }
  }

  private static class TRowMutationsTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<TRowMutations> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TRowMutations struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TRowMutations struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      ...
      struct.setRowIsSet(true);
      {
        com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList _list139 = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.mutations = new java.util.ArrayList<TMutation>(_list139.size);
        @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TMutation _elem140;
