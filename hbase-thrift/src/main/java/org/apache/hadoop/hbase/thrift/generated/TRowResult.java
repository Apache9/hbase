...
public class TRowResult implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<TRowResult, TRowResult._Fields>, java.io.Serializable, Cloneable, Comparable<TRowResult> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("TRowResult");
  ...
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField COLUMNS_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("columns", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.MAP, (short)2);
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField SORTED_COLUMNS_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("sortedColumns", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST, (short)3);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRowResultStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRowResultTupleSchemeFactory();

  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer row; // required
  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.Map<java.nio.ByteBuffer,TCell> columns; // optional
  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<TColumn> sortedColumns; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.COLUMNS, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("columns", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.MapMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.MAP, 
            new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING            , "Text"), 
            new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.StructMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, TCell.class))));
    tmpMap.put(_Fields.SORTED_COLUMNS, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("sortedColumns", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRowResult.class, metaDataMap);
  }
  ...
  public TRowResult(TRowResult other) {
    ...
    if (other.isSetColumns()) {
      ...
      for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> other_element : other.columns.entrySet()) {
        ...
        java.nio.ByteBuffer __this__columns_copy_key = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(other_element_key);
  ...
  public TRowResult setRow(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer row) {
    this.row = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(row);
    return this;
  }
  ...
  public TRowResult setColumns(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.Map<java.nio.ByteBuffer,TCell> columns) {
  ...
  public TRowResult setSortedColumns(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<TColumn> sortedColumns) {
  ...
  public int compareTo(TRowResult other) {
    ...
    if (isSetSortedColumns()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.sortedColumns, other.sortedColumns);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TRowResultStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TRowResultStandardScheme getScheme() {
      return new TRowResultStandardScheme();
    }
  }

  private static class TRowResultStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<TRowResult> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, TRowResult struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // COLUMNS
            if (schemeField.type == com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.MAP) {
              {
                com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TMap _map8 = iprot.readMapBegin();
                struct.columns = new java.util.HashMap<java.nio.ByteBuffer,TCell>(2*_map8.size);
                @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _key9;
                @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TCell _val10;
          ...
          case 3: // SORTED_COLUMNS
            if (schemeField.type == com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST) {
              {
                com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList _list12 = iprot.readListBegin();
                struct.sortedColumns = new java.util.ArrayList<TColumn>(_list12.size);
                @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TColumn _elem13;
    ...
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, TRowResult struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          ...
          {
            oprot.writeMapBegin(new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TMap(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, struct.columns.size()));
      ...
      if (struct.sortedColumns != null) {
        if (struct.isSetSortedColumns()) {
          ...
          {
            oprot.writeListBegin(new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, struct.sortedColumns.size()));
  ...
  private static class TRowResultTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TRowResultTupleScheme getScheme() {
      return new TRowResultTupleScheme();
    }
  }

  private static class TRowResultTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<TRowResult> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TRowResult struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TRowResult struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TMap _map19 = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TMap(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          ...
          @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TCell _val21;
      ...
      if (incoming.get(2)) {
        {
          com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList _list23 = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.sortedColumns = new java.util.ArrayList<TColumn>(_list23.size);
          @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TColumn _elem24;
