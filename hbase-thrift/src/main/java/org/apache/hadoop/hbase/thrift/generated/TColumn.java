...
public class TColumn implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<TColumn, TColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TColumn> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("TColumn");

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField COLUMN_NAME_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("columnName", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, (short)1);
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField CELL_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("cell", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRUCT, (short)2);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TColumnStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TColumnTupleSchemeFactory();

  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer columnName; // required
  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TCell cell; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COLUMN_NAME, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("columnName", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.CELL, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("cell", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TColumn.class, metaDataMap);
  }
  ...
  {
    this();
    this.columnName = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(columnName);
    this.cell = cell;
  }
  ...
  public TColumn(TColumn other) {
    if (other.isSetColumnName()) {
      this.columnName = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(other.columnName);
    }
    if (other.isSetCell()) {
  ...
  public byte[] getColumnName() {
    setColumnName(com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.rightSize(columnName));
    return columnName == null ? null : columnName.array();
  }

  public java.nio.ByteBuffer bufferForColumnName() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(columnName);
  }
  ...
  public TColumn setColumnName(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer columnName) {
    this.columnName = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(columnName);
    return this;
  }
  ...
  public TColumn setCell(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable TCell cell) {
    this.cell = cell;
    return this;
  }
  ...
  public int compareTo(TColumn other) {
    ...
    if (isSetColumnName()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.columnName, other.columnName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetCell()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.cell, other.cell);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (this.columnName == null) {
      ...
      com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.toString(this.columnName, sb);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("cell:");
  ...
  private static class TColumnStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TColumnStandardScheme getScheme() {
      return new TColumnStandardScheme();
    }
  }

  private static class TColumnStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<TColumn> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, TColumn struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, TColumn struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TColumnTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TColumnTupleScheme getScheme() {
      return new TColumnTupleScheme();
    }
  }

  private static class TColumnTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<TColumn> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TColumn struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TColumn struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
