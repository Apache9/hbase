...
public class TTimeRange implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<TTimeRange, TTimeRange._Fields>, java.io.Serializable, Cloneable, Comparable<TTimeRange> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("TTimeRange");

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField MIN_STAMP_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("minStamp", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.I64, (short)1);
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField MAX_STAMP_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("maxStamp", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.I64, (short)2);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TTimeRangeStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TTimeRangeTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.MIN_STAMP, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("minStamp", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    tmpMap.put(_Fields.MAX_STAMP, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("maxStamp", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.I64)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TTimeRange.class, metaDataMap);
  }
  ...
  public void unsetMinStamp() {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MINSTAMP_ISSET_ID);
  }

  /** Returns true if field minStamp is set (has been assigned a value) and false otherwise */
  public boolean isSetMinStamp() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MINSTAMP_ISSET_ID);
  }

  public void setMinStampIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MINSTAMP_ISSET_ID, value);
  }
  ...
  public void unsetMaxStamp() {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MAXSTAMP_ISSET_ID);
  }

  /** Returns true if field maxStamp is set (has been assigned a value) and false otherwise */
  public boolean isSetMaxStamp() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MAXSTAMP_ISSET_ID);
  }

  public void setMaxStampIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MAXSTAMP_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.hashCode(minStamp);

    hashCode = hashCode * 8191 + com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.hashCode(maxStamp);
  ...
  public int compareTo(TTimeRange other) {
    ...
    if (isSetMinStamp()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.minStamp, other.minStamp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetMaxStamp()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.maxStamp, other.maxStamp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TTimeRangeStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TTimeRangeStandardScheme getScheme() {
      return new TTimeRangeStandardScheme();
    }
  }

  private static class TTimeRangeStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<TTimeRange> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, TTimeRange struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      ...
      if (!struct.isSetMinStamp()) {
        throw new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocolException("Required field 'minStamp' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMaxStamp()) {
        throw new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocolException("Required field 'maxStamp' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, TTimeRange struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TTimeRangeTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TTimeRangeTupleScheme getScheme() {
      return new TTimeRangeTupleScheme();
    }
  }

  private static class TTimeRangeTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<TTimeRange> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TTimeRange struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TTimeRange struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
