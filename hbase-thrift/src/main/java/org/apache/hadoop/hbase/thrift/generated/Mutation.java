...
public class Mutation implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<Mutation, Mutation._Fields>, java.io.Serializable, Cloneable, Comparable<Mutation> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("Mutation");

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField IS_DELETE_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("isDelete", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.BOOL, (short)1);
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField COLUMN_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("column", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField WRITE_TO_WAL_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("writeToWAL", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.BOOL, (short)4);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MutationStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MutationTupleSchemeFactory();

  public boolean isDelete; // required
  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer column; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_DELETE, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("isDelete", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.COLUMN, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("column", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.VALUE, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("value", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING        , "Text")));
    tmpMap.put(_Fields.WRITE_TO_WAL, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("writeToWAL", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.BOOL)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Mutation.class, metaDataMap);
  }
    ...
    boolean writeToWAL)
  {
    ...
    this.column = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(column);
  ...
  public Mutation(Mutation other) {
    ...
    if (other.isSetColumn()) {
      this.column = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(other.column);
    }
    if (other.isSetValue()) {
  ...
  public void unsetIsDelete() {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ISDELETE_ISSET_ID);
  }

  /** Returns true if field isDelete is set (has been assigned a value) and false otherwise */
  public boolean isSetIsDelete() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ISDELETE_ISSET_ID);
  }

  public void setIsDeleteIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ISDELETE_ISSET_ID, value);
  }

  public byte[] getColumn() {
    setColumn(com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.rightSize(column));
    return column == null ? null : column.array();
  }

  public java.nio.ByteBuffer bufferForColumn() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(column);
  }
  ...
  public Mutation setColumn(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer column) {
    this.column = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(column);
    return this;
  }
  ...
  public Mutation setValue(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.nio.ByteBuffer value) {
    this.value = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.copyBinary(value);
    return this;
  }
  ...
  public void unsetWriteToWAL() {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __WRITETOWAL_ISSET_ID);
  }

  /** Returns true if field writeToWAL is set (has been assigned a value) and false otherwise */
  public boolean isSetWriteToWAL() {
    return com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __WRITETOWAL_ISSET_ID);
  }

  public void setWriteToWALIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.thirdparty.org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __WRITETOWAL_ISSET_ID, value);
  }
  ...
  public int compareTo(Mutation other) {
    ...
    if (isSetIsDelete()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.isDelete, other.isDelete);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetColumn()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.column, other.column);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetWriteToWAL()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.writeToWAL, other.writeToWAL);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (this.column == null) {
      ...
      com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.toString(this.column, sb);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("value:");
  ...
  private static class MutationStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public MutationStandardScheme getScheme() {
      return new MutationStandardScheme();
    }
  }

  private static class MutationStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<Mutation> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, Mutation struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, Mutation struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MutationTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public MutationTupleScheme getScheme() {
      return new MutationTupleScheme();
    }
  }

  private static class MutationTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<Mutation> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, Mutation struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, Mutation struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
