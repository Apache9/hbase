...
public class TAuthorization implements com.xiaomi.infra.thirdparty.org.apache.thrift.TBase<TAuthorization, TAuthorization._Fields>, java.io.Serializable, Cloneable, Comparable<TAuthorization> {
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TStruct("TAuthorization");

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField LABELS_FIELD_DESC = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TField("labels", com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST, (short)1);

  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TAuthorizationStandardSchemeFactory();
  private static final com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TAuthorizationTupleSchemeFactory();

  public @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> labels; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.LABELS, new com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData("labels", com.xiaomi.infra.thirdparty.org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    com.xiaomi.infra.thirdparty.org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TAuthorization.class, metaDataMap);
  }
  ...
  public TAuthorization setLabels(@com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public int compareTo(TAuthorization other) {
    ...
    if (isSetLabels()) {
      lastComparison = com.xiaomi.infra.thirdparty.org.apache.thrift.TBaseHelper.compareTo(this.labels, other.labels);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TAuthorizationStandardSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TAuthorizationStandardScheme getScheme() {
      return new TAuthorizationStandardScheme();
    }
  }

  private static class TAuthorizationStandardScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.StandardScheme<TAuthorization> {

    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol iprot, TAuthorization struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
            ...
            if (schemeField.type == com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.lang.String _elem9;
    ...
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol oprot, TAuthorization struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.labels != null) {
        if (struct.isSetLabels()) {
          ...
          {
            oprot.writeListBegin(new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, struct.labels.size()));
  ...
  private static class TAuthorizationTupleSchemeFactory implements com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.SchemeFactory {
    public TAuthorizationTupleScheme getScheme() {
      return new TAuthorizationTupleScheme();
    }
  }

  private static class TAuthorizationTupleScheme extends com.xiaomi.infra.thirdparty.org.apache.thrift.scheme.TupleScheme<TAuthorization> {

    @Override
    public void write(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TAuthorization struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TProtocol prot, TAuthorization struct) throws com.xiaomi.infra.thirdparty.org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList _list13 = new com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TList(com.xiaomi.infra.thirdparty.org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.labels = new java.util.ArrayList<java.lang.String>(_list13.size);
          @com.xiaomi.infra.thirdparty.org.apache.thrift.annotation.Nullable java.lang.String _elem14;
