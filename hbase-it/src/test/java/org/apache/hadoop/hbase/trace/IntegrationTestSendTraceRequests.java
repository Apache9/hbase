    ...
    for (int i = 0; i < 100; i++) {
      Runnable runnable = new Runnable() {
        ...
        public void run() {
          ...
          TracerSdkManagement sdkMgt = OpenTelemetrySdk.getGlobalTracerManagement();
          sdkMgt.updateActiveTraceConfig(
            sdkMgt.getActiveTraceConfig().toBuilder().setSampler(Sampler.alwaysOn()).build());
