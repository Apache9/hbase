...
public class NettyFutureUtils {
  ...
  public static void safeClose(ChannelOutboundInvoker channel) {
    channel.close().addListener(NettyFutureUtils::loggingWhenError);
  }
  ...
  public static void safeWrite(ChannelOutboundInvoker channel, Object msg) {
    channel.write(msg).addListener(NettyFutureUtils::loggingWhenError);
  }
  ...
  public static void safeWriteAndFlush(ChannelOutboundInvoker channel, Object msg) {
    channel.writeAndFlush(msg).addListener(NettyFutureUtils::loggingWhenError);
  }
}
