...
public class TestBytes extends TestCase {
  ...
  public void testPrevRowkey() throws IOException {
    ...
    Assert.assertArrayEquals(new byte[] { (byte) 0x00, (byte) 0xff, (byte) 0xff }, prevRowkey);
    Assert.assertTrue(Bytes.compareTo(rowkey, prevRowkey) > 0);

    rowkey = new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x00 };
    prevRowkey = Bytes.prevRowkey(rowkey, 3);
    Assert.assertArrayEquals(new byte[] { (byte) 0x01, (byte) 0x01 }, prevRowkey);
    Assert.assertTrue(Bytes.compareTo(rowkey, prevRowkey) > 0);

    rowkey = new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x01 };
    prevRowkey = Bytes.prevRowkey(rowkey, 3);
    Assert.assertArrayEquals(new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x00 }, prevRowkey);
    Assert.assertTrue(Bytes.compareTo(rowkey, prevRowkey) > 0);

    rowkey = new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x01 };
    prevRowkey = Bytes.prevRowkey(rowkey, 5);
    Assert.assertArrayEquals(
      new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0xff, (byte) 0xff }, prevRowkey);
    Assert.assertTrue(Bytes.compareTo(rowkey, prevRowkey) > 0);

    rowkey = new byte[] { (byte) 0x01, (byte) 0x01, (byte) 0x01, (byte) 0x01, (byte) 0x01 };
    try {
      prevRowkey = Bytes.prevRowkey(rowkey, 3);
