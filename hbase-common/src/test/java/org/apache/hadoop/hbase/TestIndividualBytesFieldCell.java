...
public class TestIndividualBytesFieldCell {
  ...
  public void testIllegalRow() {
    assertThrows(IllegalArgumentException.class,
      () -> new IndividualBytesFieldCell(Bytes.toBytes("row"), 0, 100, HConstants.EMPTY_BYTE_ARRAY,
        0, 0, HConstants.EMPTY_BYTE_ARRAY, 0, 0, 0L, KeyValue.Type.Put, 0,
  ...
  public void testIllegalFamily() {
    assertThrows(IllegalArgumentException.class,
      () -> new IndividualBytesFieldCell(Bytes.toBytes("row"), 0, 3, Bytes.toBytes("family"), 0,
        100, HConstants.EMPTY_BYTE_ARRAY, 0, 0, 0L, KeyValue.Type.Put, 0,
        HConstants.EMPTY_BYTE_ARRAY, 0, 0, HConstants.EMPTY_BYTE_ARRAY, 0, 0));
  }
