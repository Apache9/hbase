...
public class TestCellBlockBuilder {
  ...
  static void doBuildCellBlockUndoCellBlock(final CellBlockBuilder builder, final Codec codec,
    ...
    cellScanner = builder.createCellScanner(codec, compressor, bb.array(), 0, bb.limit());
    int i = 0;
  ...
  private static void usage(final int errCode) {
    System.out.println("Usage: IPCbuilder [options]");
    ...
    System.out.println("Example: IPCbuilder --count=1024 --size=1024");
    System.exit(errCode);
  }
