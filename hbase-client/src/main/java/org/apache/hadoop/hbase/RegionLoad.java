...
public class RegionLoad {
  ...
  public RegionLoad(ClusterStatusProtos.RegionLoad regionLoadPB) {
    ...
    for (ClusterStatusProtos.FamilyInfo info : regionLoadPB.getFamilyInfoList()) {
      this.familyLoads.add(new FamilyLoad(info));
    }
  }
  ...
  public long getScanCountPerSecond(){
    return regionLoadPB.getScanCountPerSecond();
  }

  public long getScanRowsPerSecond(){
    return regionLoadPB.getScanRowsPerSecond();
  }
