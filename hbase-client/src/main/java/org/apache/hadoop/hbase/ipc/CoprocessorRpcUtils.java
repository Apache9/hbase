...
public final class CoprocessorRpcUtils {
  ...
  private static CoprocessorServiceCall getCoprocessorServiceCall(
    ...
    .setRow(com.xiaomi.infra.thirdparty.com.google.protobuf.UnsafeByteOperations.unsafeWrap(row))
    ...
    .setRequest(com.xiaomi.infra.thirdparty.com.google.protobuf.UnsafeByteOperations.
  ...
  public static Message getRequest(Service service,
      ...
      com.xiaomi.infra.thirdparty.com.google.protobuf.ByteString shadedRequest)
  throws IOException {
