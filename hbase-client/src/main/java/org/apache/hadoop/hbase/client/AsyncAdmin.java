...
public interface AsyncAdmin {
   ...
   */
  default CompletableFuture<List<HTableDescriptor>> listTables() {
   ...
   * @return - returns a list of TableDescriptors wrapped by a {@link CompletableFuture}.
   */
  CompletableFuture<List<HTableDescriptor>> listTables(Optional<Pattern> pattern);
   ...
   */
  default CompletableFuture<Void> createTable(HTableDescriptor desc) {
   ...
   */
  CompletableFuture<Void> createTable(HTableDescriptor desc, Optional<byte[][]> splitKeys);
   ...
   */
  CompletableFuture<List<HTableDescriptor>> deleteTables(Pattern pattern);
   ...
   *         by a {@link CompletableFuture}. The return HTDs are read-only.
   */
  CompletableFuture<List<HTableDescriptor>> enableTables(Pattern pattern);
   ...
   */
  CompletableFuture<List<HTableDescriptor>> disableTables(Pattern pattern);
