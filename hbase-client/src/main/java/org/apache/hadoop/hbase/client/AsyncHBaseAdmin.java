...
/**
 * Just a wrapper of {@link RawAsyncHBaseAdmin}. The difference is that users need to provide a thread
 * pool when constructing this class, and the callback methods registered to the returned
