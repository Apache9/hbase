...
class AsyncSingleActionRpcRetryCaller<T> {

  private static final Log LOG = LogFactory.getLog(AsyncSingleActionRpcRetryCaller.class);
  ...
  public AsyncSingleActionRpcRetryCaller(HashedWheelTimer retryTimer, AsyncConnectionImpl conn,
