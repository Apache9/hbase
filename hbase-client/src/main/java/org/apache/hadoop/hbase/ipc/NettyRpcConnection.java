 ...
 * <p/>
 * <strong>Implementation assumptions:</strong> All the private methods except
 * {@link #execute(Runnable)}, should all be called in the {@link #eventLoop} thread, otherwise
 * there will be races.
 * @since 2.0.0
 */
