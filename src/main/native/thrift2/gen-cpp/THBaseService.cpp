        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->gets.resize(_size77);
            uint32_t _i81;
            for (_i81 = 0; _i81 < _size77; ++_i81)
            {
              xfer += this->gets[_i81].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_gets = true;
...
uint32_t THBaseService_getMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gets", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<TGet> ::const_iterator _iter82;
    for (_iter82 = this->gets.begin(); _iter82 != this->gets.end(); ++_iter82)
    {
...
uint32_t THBaseService_getMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->gets)).size()));
    std::vector<TGet> ::const_iterator _iter83;
    for (_iter83 = (*(this->gets)).begin(); _iter83 != (*(this->gets)).end(); ++_iter83)
    {
...
uint32_t THBaseService_getMultiple_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<TResult> ::const_iterator _iter89;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->puts.resize(_size95);
            uint32_t _i99;
            for (_i99 = 0; _i99 < _size95; ++_i99)
            {
              xfer += this->puts[_i99].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_puts = true;
...
uint32_t THBaseService_putMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("puts", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<TPut> ::const_iterator _iter100;
    for (_iter100 = this->puts.begin(); _iter100 != this->puts.end(); ++_iter100)
    {
...
uint32_t THBaseService_putMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->puts)).size()));
    std::vector<TPut> ::const_iterator _iter101;
    for (_iter101 = (*(this->puts)).begin(); _iter101 != (*(this->puts)).end(); ++_iter101)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->deletes.resize(_size102);
            uint32_t _i106;
            for (_i106 = 0; _i106 < _size102; ++_i106)
            {
              xfer += this->deletes[_i106].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_deletes = true;
...
uint32_t THBaseService_deleteMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deletes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<TDelete> ::const_iterator _iter107;
    for (_iter107 = this->deletes.begin(); _iter107 != this->deletes.end(); ++_iter107)
    {
...
uint32_t THBaseService_deleteMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->deletes)).size()));
    std::vector<TDelete> ::const_iterator _iter108;
    for (_iter108 = (*(this->deletes)).begin(); _iter108 != (*(this->deletes)).end(); ++_iter108)
    {
...
uint32_t THBaseService_deleteMultiple_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TDelete> ::const_iterator _iter114;
...
uint32_t THBaseService_getScannerRows_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TResult> ::const_iterator _iter125;
...
uint32_t THBaseService_getScannerResults_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TResult> ::const_iterator _iter136;
...
bool THBaseServiceProcessor::process(boost::shared_ptr<apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr<apache::thrift::protocol::TProtocol> poprot, void* callContext) {
...
bool THBaseServiceProcessor::process_fn(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext) {
  std::map<std::string, void (THBaseServiceProcessor::*)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*)>::iterator pfn;
