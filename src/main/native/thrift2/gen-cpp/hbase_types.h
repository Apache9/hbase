...
typedef struct _TColumnIncrement__isset {
  _TColumnIncrement__isset() : amount(false) {}
  bool amount;
...
typedef struct _TPut__isset {
  _TPut__isset() : timestamp(false), writeToWal(false), attributes(false), durability(false) {}
  bool timestamp;
  bool writeToWal;
  bool attributes;
  bool durability;
...
class TPut {
 public:
  ...
  static const char* ascii_fingerprint; // = "27F8D969F33C0F65910EFE6211FDB1C2";
  static const uint8_t binary_fingerprint[16]; // = {0x27,0xF8,0xD9,0x69,0xF3,0x3C,0x0F,0x65,0x91,0x0E,0xFE,0x62,0x11,0xFD,0xB1,0xC2};

  TPut() : row(""), timestamp(0), writeToWal(0), durability((TDurability::type)0) {
  }
...
typedef struct _TDelete__isset {
  _TDelete__isset() : columns(false), timestamp(false), deleteType(false), writeToWal(false), attributes(false), durability(false) {}
  bool columns;
  bool timestamp;
  bool deleteType;
  bool writeToWal;
...
class TDelete {
 public:
  ...
  static const char* ascii_fingerprint; // = "0ABEF316B957A922D8F6AC022D8BCA17";
  static const uint8_t binary_fingerprint[16]; // = {0x0A,0xBE,0xF3,0x16,0xB9,0x57,0xA9,0x22,0xD8,0xF6,0xAC,0x02,0x2D,0x8B,0xCA,0x17};

  TDelete() : row(""), timestamp(0), deleteType((TDeleteType::type)1), writeToWal(0), durability((TDurability::type)0) {
...
typedef struct _TIncrement__isset {
  _TIncrement__isset() : writeToWal(false) {}
  bool writeToWal;
} _TIncrement__isset;
...
typedef struct _TScan__isset {
  _TScan__isset() : startRow(false), stopRow(false), columns(false), caching(false), maxVersions(false), timeRange(false), filterString(false), batchSize(false), attributes(false) {}
  bool startRow;
  bool stopRow;
  bool columns;
  bool caching;
...
class TMutation {
 public:
  ...
  static const char* ascii_fingerprint; // = "17043DC2D933838EEE6BCE18472DCBDC";
  static const uint8_t binary_fingerprint[16]; // = {0x17,0x04,0x3D,0xC2,0xD9,0x33,0x83,0x8E,0xEE,0x6B,0xCE,0x18,0x47,0x2D,0xCB,0xDC};
...
class TRowMutations {
 public:
  ...
  static const char* ascii_fingerprint; // = "ACA19002CA15EFE0889271E1B4FCEFF6";
  static const uint8_t binary_fingerprint[16]; // = {0xAC,0xA1,0x90,0x02,0xCA,0x15,0xEF,0xE0,0x88,0x92,0x71,0xE1,0xB4,0xFC,0xEF,0xF6};
