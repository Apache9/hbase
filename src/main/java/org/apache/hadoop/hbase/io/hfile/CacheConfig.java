  ...
  private static synchronized BlockCache instantiateBlockCache(
    ...
    if (offHeapCacheSize <= 0) {
      ...
      if (bucketCacheIOEngineName != null && bucketCacheSize > 0) {
        ...
        if (combinedWithLru) {
          cacheSize = (long) ((1 - combinedPercentage) * bucketCacheSize);
        ...
        try {
          ...
          bucketCache = new BucketCache(bucketCacheIOEngineName,
              bucketCacheSize, bucketSizes, writerThreads, writerQueueLen, persistentPath,
      ...
      LruBlockCache lruCache = new LruBlockCache(cacheSize,
